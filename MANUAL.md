...
### 1. Закупка необходимых деталей
По [ссылке](https://github.com/dark516/Frob_robot/blob/main/assembly_guide/FROB_parts_and_prices.xlsx) находится таблица для закупки необходимых компонентов. Цены на компоненты ориентировочны и могут меняться.
...
### 2. Сборка платформы
После приобретения всех деталей, вы можете приступить к сборке. Для этого следуйте специальной [пошаговой инструкцие](https://github.com/mi1en/Frob_robot/blob/patch-2/assembly_guide/assembly_guide.png).
