...
### 2. Сборка платформы
После приобретения всех деталей, вы можете приступить к сборке. Для этого следуйте специальной [пошаговой инструкцие](https://github.com/dark516/Frob_robot/blob/main/assembly_guide/assembly_guide.png).
